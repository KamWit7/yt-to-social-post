...
export function UsageGate({ children }: UsageGateProps) {
  ...
  if (usageStats?.success) {
    ...
    return (
      <div className='flex items-center justify-center py-12'>
        <div className='bg-gradient-to-br from-orange-100 to-red-50 dark:from-orange-900/20 dark:to-red-800/10 backdrop-blur-sm rounded-xl border-2 border-orange-200 dark:border-orange-700 p-8 max-w-md w-full mx-4'>
          <div className='text-center space-y-6'>
            ...
            <div className='space-y-3'>
              ...
              <p className='text-sm text-gray-600 dark:text-gray-400 leading-relaxed'>
                {USAGE_GATE_TEXT.DESCRIPTION.replace(
                  '{limit}',
                  limit.toString()
                )}
              </p>
  ...
  // Fallback: if something went wrong, allow access (fail-open)
  return <>{children}</>
}
