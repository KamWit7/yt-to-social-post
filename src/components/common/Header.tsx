      ...
      <nav className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-16'>
          ...
          <Button
            ...
            variant='ghost'
            className='flex items-center space-x-2 px-3 py-1.5 rounded-full text-gray-600 dark:text-gray-300 hover:bg-accent/60 dark:hover:bg-accent/40 text-sm font-semibold transition-colors'>
